...
WEBHOOK_URL ="https://2c90-2401-4900-172a-2477-6425-9933-277-82a.ngrok-free.app" # Your server's public URL
...
async def telegram_webhook(request: Request,background_tasks: BackgroundTasks):
    try:
        ...
        if "message" in update:
            ...
            background_tasks.add_task(process_telegram_query,chat_id, user_query)
